...
# Set your phone IP and port below:
stream_url = "http://192.168.1.248:8080/video"   # <-- Replace with the stream that works in your browser
...
print("Starting YOLOv8 pose detection (video stream). Press 'q' to quit.")
