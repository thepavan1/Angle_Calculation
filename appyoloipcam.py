...
# For IP webcam snapshot
url = "http://192.168.1.248:8080/shot.jpg"
save_dir = "processed_frames"
os.makedirs(save_dir, exist_ok=True)

print("Starting YOLOv8 pose detection (IP webcam snapshot mode). Press 'q' to quit.")
...
while True:
    try:
        ...
        if frame is None:
            print("Failed to decode frame from IP webcam.")
            continue
    ...
    # Save processed frame every 3 seconds
